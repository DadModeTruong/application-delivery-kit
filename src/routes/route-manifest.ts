...
export const routes: Route[] = [
  { path: '/', component: HomePage, title: 'Application Delivery Kit' },
  {
    ...
    component: LayoutsExamplesPage,
    title: 'Application Delivery Kit | Examples | Layouts',
  },
  {
    path: '/examples/layouts/header-only',
    component: LayoutsHeaderOnlyGuidePage,
    title: 'Application Delivery Kit | Examples | Layouts | Header Only',
  },
  {
    path: '/examples/layouts/secondary',
    component: LayoutsSecondaryGuidePage,
    title: 'Application Delivery Kit | Examples | Layouts | Secondary',
  },
  {
    path: '/examples/layouts/sidebar',
    component: LayoutsSidebarGuidePage,
    title: 'Application Delivery Kit | Examples | Layouts | Sidebar',
  },
  {
    path: '/examples/layouts/full',
    component: LayoutsFullGuidePage,
    title: 'Application Delivery Kit | Examples | Layouts | Full',
  },
  {
    path: '/layouts/header-only',
    component: LayoutsHeaderOnlyPage,
    title: 'Application Delivery Kit | Layouts | Header Only',
  },
  {
    path: '/layouts/secondary',
    component: LayoutsSecondaryPage,
    title: 'Application Delivery Kit | Layouts | Secondary',
  },
  {
    path: '/layouts/sidebar',
    component: LayoutsSidebarPage,
    title: 'Application Delivery Kit | Layouts | Sidebar',
  },
  {
    path: '/layouts/full',
    component: LayoutsFullPage,
    title: 'Application Delivery Kit | Layouts | Full',
  },
  {
    path: '/components/header',
    component: ComponentsHeaderPage,
    title: 'Application Delivery Kit | Components | User Interface | Header',
  },
  {
    path: '/components/tab-navigation',
    component: ComponentsTabNavigationPage,
    title: 'Application Delivery Kit | Components | User Interface | Tab Navigation',
  },
  {
    path: '/components/sidebar',
    component: ComponentsSidebarPage,
    title: 'Application Delivery Kit | Components | User Interface | Sidebar',
  },
  {
    path: '/components/footer',
    component: ComponentsFooterPage,
    title: 'Application Delivery Kit | Components | User Interface | Footer',
  },
  {
  ...
  },
  {
    ...
    component: ComponentsInteractionPage,
    title: 'Application Delivery Kit | Components | Interaction',
  },
  {
    path: '/components/forms',
    component: ComponentsFormsPage,
    title: 'Application Delivery Kit | Components | Forms',
  },
  {
    path: '/components/input',
    component: ComponentsInputPage,
    title: 'Application Delivery Kit | Components | Forms | Input',
  },
  {
    path: '/components/select',
    component: ComponentsSelectPage,
    title: 'Application Delivery Kit | Components | Forms | Select',
  },
  {
    path: '/components/textarea',
    component: ComponentsTextareaPage,
    title: 'Application Delivery Kit | Components | Forms | Text Area',
  },
  {
    path: '/components/checkbox',
    component: ComponentsCheckboxPage,
    title: 'Application Delivery Kit | Components | Forms | Checkbox',
  },
  {
    path: '/components/checkbox-group',
    component: ComponentsCheckboxGroupPage,
    title: 'Application Delivery Kit | Components | Forms | Checkbox Group',
  },
  {
    path: '/components/radio',
    component: ComponentsRadioPage,
    title: 'Application Delivery Kit | Components | Forms | Radio Button',
  },
  {
    path: '/components/combobox',
    component: ComponentsComboboxPage,
    title: 'Application Delivery Kit | Components | Forms | Combobox',
  },
  {
    path: '/components/datepicker',
    component: ComponentsDatepickerPage,
    title: 'Application Delivery Kit | Components | Forms | Datepicker',
  },
  {
    path: '/components/card',
    component: ComponentsCardsPage,
    title: 'Application Delivery Kit | Components | User Interface | Card',
  },
  {
    path: '/components/split-view',
    component: ComponentsSplitViewPage,
    title: 'Application Delivery Kit | Components | User Interface | Split View',
  },
  {
    path: '/components/button',
    component: ComponentsButtonsPage,
    title: 'Application Delivery Kit | Components | Interaction | Button',
  },
]
