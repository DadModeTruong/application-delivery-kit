/** Shared site navigation; route ownership remains in the route manifest. */
import type { SVGProps } from 'react'
import type { LucideIcon } from 'lucide-react'
import type { NavItem, NavLeaf } from '@/components/layout/types'
const primaryNav: NavItem[] = [
  { label: 'Layouts', children: [
...
const GithubIcon: LucideIcon = (({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className={className} {...props}>
...
const footerLinks: NavLeaf[] = [{ href: 'https://github.com/RealityTommy/application-delivery-kit', label: 'GitHub', icon: GithubIcon, external: true }]
export { primaryNav, footerLinks }
