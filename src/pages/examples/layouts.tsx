      ...
      <div className="space-y-14">
        <section className="space-y-5" aria-labelledby="layouts-heading">
          ...
          <p className="text-xl leading-8 text-muted-foreground">
            Page-level compositions that shape how people understand a product, move through its information architecture, and complete work.
          </p>
          <p className="leading-7 text-muted-foreground">
            A layout is not just a visual arrangement. It establishes navigation ownership, reading order, route structure, responsive behavior, accessibility obligations, analytics boundaries, and the cost of future change. Choose the smallest pattern that supports the real information architecture, then test it with realistic growth before committing.
          </p>
        </section>
        <section className="space-y-5" aria-labelledby="layouts-what-heading">
          ...
          <p className="leading-7 text-muted-foreground">
            These are complete page-shell patterns, not another component category. Use the detail guides to make an intentional decision; use the separate demo pages to inspect the production composition. Do not select a more complex shell simply because it looks more complete in a static mockup.
          </p>
        </section>
        ...
        <section className="space-y-5" aria-labelledby="layouts-decision-heading">
          <h2 id="layouts-decision-heading" className="text-2xl font-semibold tracking-tight">A practical decision path</h2>
          <ol className="list-decimal space-y-4 pl-5 leading-7 text-muted-foreground">
            <li><strong className="text-foreground">Start with the information architecture.</strong> List the destinations, their relationships, expected growth, permissions, and likely changes. Do not start with the shell that looks best in a screenshot.</li>
            <li><strong className="text-foreground">Choose the lowest-complexity pattern.</strong> Use Header Only for one clear task, Secondary for a short peer set, Sidebar for grouped section navigation, and Full only when both contextual layers are genuinely necessary.</li>
            <li><strong className="text-foreground">Test the future, not only today.</strong> Add realistic labels, long content, localization, hidden permissions, deeper routes, and mobile behavior to the prototype.</li>
            <li><strong className="text-foreground">Name the cost before approval.</strong> Identify who owns the navigation model, active state, responsive transformation, analytics, accessibility review, and future migration.</li>
        ...
        <section className="grid gap-10 lg:grid-cols-2" aria-labelledby="layouts-cost-heading">
          <div className="space-y-5">
            ...
            <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
              ...
              <li>Responsive behavior is often a second information architecture, not just a smaller desktop layout.</li>
          ...
          <div className="space-y-5" aria-labelledby="layouts-risk-heading">
            ...
            <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
              ...
              <li>A sidebar is becoming a list of team names, technical systems, or every possible destination.</li>
        ...
        <section className="space-y-5" aria-labelledby="layouts-roles-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ['Product', 'Clarifies the user jobs, section boundaries, expected growth, and success measures.'],
              ['Design and content', 'Defines hierarchy, labels, grouping, reading order, responsive behavior, and content capacity.'],
              ['Engineering', 'Estimates shell, route, state, data, permissions, analytics, and migration complexity.'],
              ['Accessibility', 'Reviews landmarks, keyboard flow, current location, focus, reflow, zoom, and assistive-technology comprehension.'],
              ['Research or support', 'Brings evidence about findability, terminology, common paths, and real-world confusion.'],
              ['Operations and governance', 'Sets ownership, review triggers, release risk, documentation, and the process for navigation changes.'],
        ...
        <section className="space-y-5" aria-labelledby="layouts-checklist-heading">
          <h2 id="layouts-checklist-heading" className="text-2xl font-semibold tracking-tight">Before approving a layout</h2>
          <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
            <li>Can the team state why this pattern is needed and why a simpler pattern is not enough?</li>
            <li>Have we tested realistic content, growth, permissions, localization, deep links, and narrow screens?</li>
            ...
            <li>Have we recorded the migration cost and the signal that would cause us to revisit the decision?</li>
          </ul>
        </section>
      </div>
    </LayoutGuideShell>
