...
import { NavigationHeaderPage } from './components-navigation-header'
import { NavigationSecondaryPage } from './components-navigation-secondary'
import { NavigationSidebarPage } from './components-navigation-sidebar'
import { NavigationFooterPage } from './components-navigation-footer'
...
const routes: Route[] = [
  ...
  { path: '/components/navigation/header', component: NavigationHeaderPage },
  { path: '/components/navigation/secondary', component: NavigationSecondaryPage },
  { path: '/components/navigation/sidebar', component: NavigationSidebarPage },
  { path: '/components/navigation/footer', component: NavigationFooterPage },
