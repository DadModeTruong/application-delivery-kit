...
function BasicDatepickerExample() {
  return (
    <Field id="intro-datepicker" label="Start date">
      <input id="intro-datepicker" className={`${inputClass} [color-scheme:light]`} type="date" />
    </Field>
  )
}
...
function ComponentsDatepickerPage() {
  return (
    <FormGuide
      kind="datepicker"
      title="Datepicker"
      description="Use Datepicker for a calendar date. Preserve a usable text and keyboard path alongside calendar affordances."
      basicExample={<BasicDatepickerExample />}
      variations={<DatepickerVariations />}
    />
  )
}
