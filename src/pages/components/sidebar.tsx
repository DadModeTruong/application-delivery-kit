    ...
    >
      <div className="space-y-12">
        <section className="space-y-5" aria-labelledby="navigation-sidebar-heading">
          <h1 id="navigation-sidebar-heading" className="text-4xl font-semibold tracking-tight">
            Sidebar navigation
          </h1>
        ...
        <section className="space-y-5" aria-labelledby="navigation-sidebar-what-heading">
          ...
          <p className="leading-7 text-muted-foreground">
            A Sidebar exposes hierarchical or grouped destinations within an application area. It
            gives people a persistent place to understand where they are and what related
            destinations are available.
          </p>
          <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
            <li>
              Use grouping and nesting to communicate information architecture, not just to fit more
              links on the page.
            </li>
            <li>
            ...
            <li>
              Use the mobile replacement when the persistent rail cannot remain visible at narrow
              widths.
            </li>
          </ul>
          <p className="leading-7 text-muted-foreground">
            ...
            persistent navigation landmark beside Main on wider screens; on smaller screens, the
            same navigation data moves into the Header’s temporary drawer.
          </p>
          ...
          <p className="leading-7 text-muted-foreground">
            Sidebar navigation is a persistent, hierarchical map of an area’s destinations. Use it
            when people need to move among related pages while keeping their place in the main
            content; use Header for broad product navigation and TabNavigation for a smaller set of
            nearby destinations.
          </p>

          <p className="text-sm leading-6 text-muted-foreground">
            Try it: move through the sidebar links with the keyboard and resize the page to confirm
            the navigation remains discoverable and usable.
          </p>
        </section>
        <section
        ...
        >
          <div className="space-y-5">
            ...
            <p className="leading-7 text-muted-foreground">
              Use a Sidebar when people need to move among related destinations while preserving the
              structure of a larger area.
            </p>
            <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
              <li>
                Use it for grouped settings, workspace areas, administration, documentation, or
                other deep information architecture.
              </li>
              <li>
                Use nested items only when the parent-child relationship is meaningful and the depth
                remains manageable.
              </li>
              <li>
                Use an icon-only or collapsed presentation only when tooltips and accessible names
                preserve the meaning of every destination.
              </li>
            </ul>
          ...
          <div className="space-y-5" aria-labelledby="navigation-sidebar-not-heading">
            ...
            <p className="leading-7 text-muted-foreground">
              Do not use a Sidebar for a short, flat set of peer destinations or for product-wide
              links that belong in the Header.
            </p>
            <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
              <li>
                Choose Tab navigation when destinations are peers within one area and should remain
                visible together.
              </li>
              <li>
            ...
            <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
              ...
              <li>
                For deeply nested navigation that needs more than one supported grouping level.
              </li>
              <li>
                When the rail would take more space than the content earns or hide the main task.
              </li>
            </ul>
          </div>
        </section>
        <section className="space-y-5" aria-labelledby="navigation-sidebar-design-heading">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 leading-7 text-muted-foreground">
            <li>
              Use group headings that describe the information architecture, not visual decoration.
            </li>
            <li>
              Keep one supported grouping level; use Header dropdowns or another pattern when deeper
              disclosure is needed.
            </li>
            <li>
              Use icons only when they add recognition value, and keep labels visible in the labeled
              variant.
            </li>
            <li>
              Keep labels concise, parallel, and consistent with page titles and related navigation.
            </li>
            <li>
              Preserve the main content’s width and reading order; the rail should support the task,
              not compete with it.
            </li>
          </ul>
        </section>

        <section className="space-y-5" aria-labelledby="navigation-sidebar-accessibility-heading">
          <h2
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 leading-7 text-muted-foreground">
            <li>
              Give the sidebar landmark a specific name, and avoid reusing an indistinguishable
              label when other navigation landmarks are nearby.
            </li>
            <li>
              Use real links so browser navigation, keyboard activation, and link context work as
              expected.
            </li>
            <li>
              Mark only the current destination with <code>aria-current="page"</code>; do not use
              color or indentation as the only state cue.
            </li>
            <li>
              Keep the main content earlier in the DOM reading order when the visual rail is beside
              it.
            </li>
            <li>
              In icon-only mode, provide a visible or programmatic label for every link and test
              tooltip/focus behavior without a pointer.
            </li>
            <li>
              When the rail becomes a drawer, test the trigger name and expanded state, focus entry,
              Escape/outside dismissal, and focus restoration.
            </li>
          </ul>
        </section>
        <section className="space-y-5" aria-labelledby="navigation-sidebar-responsive-heading">
          <h2
          ...
          <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
            <li>
              Preserve group order, labels, and active-location context in the mobile presentation.
            </li>
        ...
        <section className="space-y-5" aria-labelledby="navigation-sidebar-examples-heading">
          ...
          <p className="text-sm text-muted-foreground">
            Try it: move through grouped and nested destinations with the keyboard, verify active
            and collapsed states, resize to the mobile replacement, and confirm focus, labels, and
            hierarchy remain understandable.
          </p>
