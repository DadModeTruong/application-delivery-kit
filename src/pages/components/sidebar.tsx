            ...
            <div className="space-y-12 px-4 pb-12 pt-6 sm:px-6 lg:px-8">
              ...
              <section className="space-y-5" aria-labelledby="navigation-sidebar-what-heading">
                ...
                <p className="leading-7 text-muted-foreground">
                  A Sidebar exposes hierarchical or grouped destinations within an application area.
                  It gives people a persistent place to understand where they are and what related
                  destinations are available.
                </p>
                <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                  <li>
                    Use grouping and nesting to communicate information architecture, not just to
                    fit more links on the page.
                  </li>
                  <li>
                    Keep labels, indentation, and expanded states consistent so the hierarchy can be
                    scanned quickly.
                  </li>
                  <li>
                    Use the mobile replacement when the persistent rail cannot remain visible at
                    narrow widths.
                  </li>
                </ul>
                <p className="leading-7 text-muted-foreground">
                  Sidebar gives a section enough space for grouped destinations, optional icons, and
                  a visible current-page state without making the Header carry every link. It is a
                ...
                <p className="leading-7 text-muted-foreground">
                  Sidebar navigation is a persistent, hierarchical map of an area’s destinations.
                  Use it when people need to move among related pages while keeping their place in
                  the main content; use Header for broad product navigation and TabNavigation for a
                  smaller set of nearby destinations.
                </p>

                <p className="text-sm leading-6 text-muted-foreground">
                  Try it: move through the sidebar links with the keyboard and resize the page to
                  confirm the navigation remains discoverable and usable.
                </p>
              </section>
              <section
              ...
              >
                <div className="space-y-5">
                  ...
                  <p className="leading-7 text-muted-foreground">
                    Use a Sidebar when people need to move among related destinations while
                    preserving the structure of a larger area.
                  </p>
                  <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                    <li>
                      Use it for grouped settings, workspace areas, administration, documentation,
                      or other deep information architecture.
                    </li>
                    <li>
                      Use nested items only when the parent-child relationship is meaningful and the
                      depth remains manageable.
                    </li>
                    <li>
                      Use an icon-only or collapsed presentation only when tooltips and accessible
                      names preserve the meaning of every destination.
                    </li>
                  </ul>
                  <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
                    <li>For a deeper set of related pages that benefits from a persistent map.</li>
                    <li>
                      When meaningful group labels help people predict where a destination belongs.
                    </li>
                    <li>
                      When the page has enough width for a rail without compressing the main task.
                    </li>
                    <li>
                      When the same navigation can become a clearly named, keyboard-operable mobile
                      drawer.
                    </li>
                  </ul>
                </div>
                <div className="space-y-5" aria-labelledby="navigation-sidebar-not-heading">
                  ...
                  <p className="leading-7 text-muted-foreground">
                    Do not use a Sidebar for a short, flat set of peer destinations or for
                    product-wide links that belong in the Header.
                  </p>
                  <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                    <li>
                      Choose Tab navigation when destinations are peers within one area and should
                      remain visible together.
                    </li>
                    <li>
                      Avoid deep nesting, duplicate parent links, or groups that contain only one
                      unrelated item.
                    </li>
                  ...
                  <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
                    ...
                    <li>
                      For broad destinations shared by the whole application; use Header instead.
                    </li>
                    <li>
                      For deeply nested navigation that needs more than one supported grouping
                      level.
                    </li>
                    <li>
                      When the rail would take more space than the content earns or hide the main
                      task.
                    </li>
                  </ul>
                </div>
              ...
              <section className="space-y-5" aria-labelledby="navigation-sidebar-design-heading">
                ...
                <p className="leading-7 text-muted-foreground">
                  Make hierarchy visible through grouping, indentation, spacing, and predictable
                  expansion. The Sidebar should help people build a mental model of the area without
                  becoming a second content panel.
                </p>
                <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                  <li>
                    Keep group labels concise and use consistent indentation for child destinations.
                  </li>
                  <li>
                    Make the active destination visually distinct without depending on color alone.
                  </li>
                  <li>
                    Keep collapsed and icon-only states discoverable with tooltips or equivalent
                    accessible names.
                  </li>
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 leading-7 text-muted-foreground">
                  <li>
                    Use group headings that describe the information architecture, not visual
                    decoration.
                  </li>
                  <li>
                    Keep one supported grouping level; use Header dropdowns or another pattern when
                    deeper disclosure is needed.
                  </li>
                  <li>
                    Use icons only when they add recognition value, and keep labels visible in the
                    labeled variant.
                  </li>
                  <li>
                    Keep labels concise, parallel, and consistent with page titles and related
                    navigation.
                  </li>
                  <li>
                    Preserve the main content’s width and reading order; the rail should support the
                    task, not compete with it.
                  </li>
                </ul>
              </section>
              ...
              >
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 leading-7 text-muted-foreground">
                  <li>
                    Give the sidebar landmark a specific name, and avoid reusing an
                    indistinguishable label when other navigation landmarks are nearby.
                  </li>
                  <li>
                    Use real links so browser navigation, keyboard activation, and link context work
                    as expected.
                  </li>
                  <li>
                    Mark only the current destination with <code>aria-current="page"</code>; do not
                    use color or indentation as the only state cue.
                  </li>
                  <li>
                    Keep the main content earlier in the DOM reading order when the visual rail is
                    beside it.
                  </li>
                  <li>
                    In icon-only mode, provide a visible or programmatic label for every link and
                    test tooltip/focus behavior without a pointer.
                  </li>
                  <li>
                    When the rail becomes a drawer, test the trigger name and expanded state, focus
                    entry, Escape/outside dismissal, and focus restoration.
                  </li>
                </ul>
              </section>
              <section
              ...
              >
                ...
                <p className="leading-7 text-muted-foreground">
                  At narrow widths, move the same Sidebar destinations into an accessible mobile
                  replacement rather than silently removing them.
                </p>
                <ul className="list-disc space-y-2 pl-5 text-muted-foreground">
                  <li>
                    Preserve group order, labels, and active-location context in the mobile
                    presentation.
                  </li>
                  <li>
                    Verify that opening and closing the replacement does not strand keyboard focus.
                  </li>
                  <li>Test long group labels, nested items, browser zoom, and narrow windows.</li>
                  <li>
                    Ensure the collapsed or mobile presentation is understandable without relying on
                    hover.
                  </li>
                </ul>
                <p className="leading-7 text-muted-foreground">
                ...
                <p className="leading-7 text-muted-foreground">
                  ...
                  and focus returns to the menu trigger when it closes. Test at narrow widths and
                  high zoom so labels, touch targets, and the main content remain usable without
              ...
              <section className="space-y-5" aria-labelledby="navigation-sidebar-examples-heading">
                ...
                <p className="text-sm text-muted-foreground">
                  Try it: move through grouped and nested destinations with the keyboard, verify
                  active and collapsed states, resize to the mobile replacement, and confirm focus,
                  labels, and hierarchy remain understandable.
                </p>
                ...
                <div className="space-y-8 [&_*:has(>[data-slot=sidebar])]:!p-0 [&_*:has(>[data-slot=sidebar])]:overflow-hidden">
                  ...
                  <ExampleVariation
                    ...
                    description="Use the active state to show where people are within the current area."
                    explanation="The active destination should be identifiable through styling and semantics, not color alone. Keep activeHref synchronized with the current route so people can understand where they are."
                    doItems={[
