...
function ComponentsComboboxPage() {
  return <FormGuide kind="combobox" title="Combobox" description="Use Combobox when people need to choose from a list that can be searched or filtered." basicExample={<BasicComboboxExample />} variations={<ComboboxVariations />} />
}
