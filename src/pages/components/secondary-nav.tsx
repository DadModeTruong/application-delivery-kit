            ...
            <div className="space-y-12 pb-12 pt-6">
              ...
              >
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Basic contextual navigation</h3><p className="mt-1 text-sm text-muted-foreground">A labeled navigation region groups destinations inside one product area.</p></div><div className="rounded-md border bg-muted/20 p-4"><nav aria-label="Project sections" className="flex flex-wrap gap-4 text-sm"><a href="#secondary-overview" aria-current="page" className="font-semibold underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Overview</a><a href="#secondary-activity" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Activity</a><a href="#secondary-settings" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Settings</a></nav></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> people move between related sections while staying in the same area.</p><p><strong>Avoid when:</strong> there is only one destination or the items represent sequential steps.</p><p><strong>Check:</strong> the navigation has a useful label and the active destination uses semantic state.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Long list with overflow</h3><p className="mt-1 text-sm text-muted-foreground">A bounded region can preserve access to all items without forcing the page wider.</p></div><div className="overflow-x-auto rounded-md border bg-muted/20 p-4"><nav aria-label="Workspace sections" className="flex min-w-max gap-4 text-sm"><a href="#secondary-one" aria-current="page" className="font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Overview</a><a href="#secondary-two" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Members</a><a href="#secondary-three" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Billing</a><a href="#secondary-four" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Integrations</a><a href="#secondary-five" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Audit log</a></nav></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> horizontal scrolling is an understood, discoverable response to a short row of related links.</p><p><strong>Avoid when:</strong> users need to see all choices at once or the list is too long to scan.</p><p><strong>Check:</strong> keyboard users can reach every item and the overflow treatment does not hide the active state.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Narrow-screen alternative</h3><p className="mt-1 text-sm text-muted-foreground">Collapse only when the implementation provides an equivalent menu.</p></div><div className="rounded-md border bg-muted/20 p-4"><div className="flex items-center justify-between gap-3"><span className="font-semibold">Project sections</span><button type="button" aria-label="Open project sections" className="rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Sections</button></div></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> the full row cannot remain readable at the target width.</p><p><strong>Avoid when:</strong> the menu hides high-frequency navigation without a strong reason.</p><p><strong>Check:</strong> expanded state, focus movement, Escape dismissal, and focus restoration are implemented—not merely styled.</p></div></article>
                </div>
                <p className="leading-7 text-muted-foreground">
