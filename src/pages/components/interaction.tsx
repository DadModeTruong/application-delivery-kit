      ...
      <div className="space-y-14">
        ...
        <section className="space-y-5" aria-labelledby="interaction-what-heading">
          ...
          <p className="leading-7 text-muted-foreground">
            This area covers controls and navigation patterns that respond to input and communicate
            an action or state. The most important choice is the semantic one: use a button for an
            action and a link for navigation.
          </p>
        ...
        <section className="space-y-5" aria-labelledby="interaction-guides-heading">
          <div className="space-y-2">
            ...
            <p className="leading-7 text-muted-foreground">
              Start with the guide that matches the action people need to take. Each guide explains
              the semantic choice, states, content, accessibility, and responsive behavior to
        ...
        <section className="space-y-5" aria-labelledby="interaction-guidance-heading">
          ...
          <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
            <li>
              Describe the result of the action with a short, specific verb such as Save, Apply, or
              Close.
            </li>
            <li>Use one clear primary action and reduce emphasis for nearby alternatives.</li>
            <li>
              Keep buttons, links, and other controls keyboard accessible and visibly focusable.
            </li>
            <li>
              Show unavailable, busy, selected, or destructive states in a way that does not rely on
              color alone.
            </li>
            <li>
        ...
        <section className="space-y-5" aria-labelledby="interaction-questions-heading">
          ...
          <ul className="list-disc space-y-3 pl-5 leading-7 text-muted-foreground">
            ...
            <li>
              Will the label still make sense if someone only hears the control out of context?
            </li>
            <li>What should people see while the action is unavailable or in progress?</li>
            <li>
              What happens after activation, and is that result clear to keyboard and screen-reader
              users?
            </li>
          </ul>
        </section>
