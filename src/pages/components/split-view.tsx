            ...
            <article className="space-y-6 rounded-lg border p-6 sm:p-8">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Give Main more room when Secondary provides context, a preview, or supporting
                  details.
                </p>
              </div>
              <SplitPaneDemo
              ...
              <div className="grid gap-8 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <ul className="mt-3 list-disc space-y-3 pl-5 text-muted-foreground">
                    ...
                    <li>Assume the desktop proportion stays side by side at narrow widths.</li>
                  </ul>
                </div>
              </div>
              <p className="text-sm leading-6 text-muted-foreground">
                <strong>Check:</strong> Open and close details at wide and narrow widths. The
                primary task should stay usable, the supporting content should remain related, and
                focus should return to the opening control when details close.
              </p>
            </article>
            <article className="space-y-6 rounded-lg border p-6 sm:p-8">
              <div className="space-y-2">
                <h3 className="text-xl font-semibold tracking-tight">Main half, Secondary half</h3>
                <p className="text-muted-foreground">
                  Give both areas equal room when people need to compare or move between related
                  views.
                </p>
              </div>
              <SplitPaneDemo
              ...
              <div className="grid gap-8 sm:grid-cols-2">
                ...
                <div>
                  <h4 className="font-semibold">Don&apos;t</h4>
                  <ul className="mt-3 list-disc space-y-3 pl-5 text-muted-foreground">
                    <li>Use equal columns when one area is clearly only supporting context.</li>
                    <li>
                      Allow dense content or long labels to make either pane difficult to use.
                    </li>
                    <li>Treat equal width as equal priority when task order still matters.</li>
                  </ul>
                </div>
              </div>
              <p className="text-sm leading-6 text-muted-foreground">
                <strong>Check:</strong> Compare the two areas with realistic content at wide and
                narrow widths. Both should remain readable, while headings and reading order still
                communicate which task comes first.
              </p>
            </article>
          </div>
        </section>
