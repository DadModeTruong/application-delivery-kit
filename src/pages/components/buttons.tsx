      ...
      <div className="space-y-14">
        ...
        <section className="space-y-5" aria-labelledby="buttons-what-heading">
          ...
          <p className="text-sm leading-6 text-muted-foreground">
            Try it: move to the button with the keyboard and confirm that the focus indicator is
            visible before activating it.
          </p>
        </section>
        ...
        <section className="space-y-6" aria-labelledby="buttons-examples-heading">
          ...
          <div className="space-y-8">
            <ExampleVariation
              ...
              explanation={
                <>
                  Use visual emphasis to communicate priority and consequence. Compare the styles
                  below, then choose the least prominent style that still makes the action clear.
                  <ul className="mt-3 list-disc space-y-2 pl-5">
                    <li>Default: use for the primary action in a task.</li>
                    <li>
                      Secondary and outline: use for supporting actions that should remain available
                    ...
                    <li>
                      Destructive: use for irreversible or high-consequence actions such as deleting
                      or removing data.
                    </li>
                    <li>
                  ...
                  <p className="mt-3">
                    Try it: identify the one primary action, then check that the quieter styles do
                    not compete with it.
                  </p>
                </>
              }
