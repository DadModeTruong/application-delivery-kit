            ...
            <div className="space-y-14 px-4 pb-12 pt-6 sm:px-6 lg:px-8">
              ...
              <section className="space-y-5" aria-labelledby="buttons-examples-heading">
                ...
                <div className="space-y-6">
                  ...
                  <article className="space-y-4 rounded-lg border bg-card p-6"><div><h3 className="text-lg font-semibold">Icon and text</h3><p className="mt-1 text-sm text-muted-foreground">Icons reinforce a familiar action; they do not replace a clear label when the action is unfamiliar.</p></div><div className="flex flex-wrap gap-3 rounded-md border bg-muted/20 p-4"><button type="button" className="rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">＋ Add member</button><button type="button" aria-label="Open settings" className="rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">⚙</button></div><div className="space-y-3 text-sm">
                      <div className="grid gap-3 sm:grid-cols-2">
                        <div className="rounded-md border border-emerald-200 bg-emerald-50 p-3 text-emerald-950 dark:border-emerald-900 dark:bg-emerald-950/30 dark:text-emerald-100">
                          <p className="font-semibold">Do</p>
