              ...
              <section className="space-y-5" aria-labelledby="navigation-header-examples-heading">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <article className="space-y-3 rounded-lg border bg-card p-4">
                    ...
                    <div className="space-y-1 text-sm"><p><strong>Use when:</strong> people need consistent access to identity and top-level destinations.</p><p><strong>Avoid when:</strong> the region is being used to hold every page-specific control.</p><p><strong>Check:</strong> the header and primary navigation have meaningful landmarks and the current destination is not communicated by color alone.</p></div>
                  </article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Header with utility action</h3><p className="mt-1 text-sm text-muted-foreground">A global action stays separate from destination links.</p></div><div className="rounded-md border bg-muted/20 p-4"><header aria-label="Account header" className="flex flex-wrap items-center justify-between gap-4"><span className="font-semibold">Acme workspace</span><div className="flex flex-wrap items-center gap-3"><nav aria-label="Workspace navigation" className="flex gap-3 text-sm"><a href="#header-example-dashboard" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Dashboard</a><a href="#header-example-reports" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Reports</a></nav><button type="button" className="rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Sign out</button></div></header></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> an action is available across the product and has a clear global consequence.</p><p><strong>Avoid when:</strong> the action only applies to the current page or record.</p><p><strong>Check:</strong> links and buttons retain their native semantics and focus order.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Compact header</h3><p className="mt-1 text-sm text-muted-foreground">At narrow widths, preserve access to navigation instead of hiding it.</p></div><div className="rounded-md border bg-muted/20 p-4"><header aria-label="Compact site header" className="flex items-center justify-between gap-3"><button type="button" aria-label="Open primary navigation" className="rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Menu</button><span className="font-semibold">Acme</span><a href="#header-example-help" className="text-sm underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Help</a></header></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> the full navigation cannot fit without damaging readability or touch targets.</p><p><strong>Avoid when:</strong> a menu button would hide a destination people need to compare frequently.</p><p><strong>Check:</strong> the trigger has an accessible name, a visible focus state, and a real open/close behavior in the production implementation.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Page-specific action</h3><p className="mt-1 text-sm text-muted-foreground">A local action belongs with the page heading, not in the global header.</p></div><div className="rounded-md border bg-muted/20 p-4"><div className="flex flex-wrap items-center justify-between gap-4"><h3 className="font-semibold">Project settings</h3><button type="button" className="rounded-md bg-primary px-3 py-2 text-sm text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Save changes</button></div></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> the action changes the current page or record.</p><p><strong>Avoid when:</strong> the action is needed from every page.</p><p><strong>Check:</strong> its placement and accessible name explain its scope before activation.</p></div></article>
                </div>
                <p className="leading-7 text-muted-foreground">
