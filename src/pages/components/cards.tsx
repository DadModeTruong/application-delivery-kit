            ...
            <div className="space-y-14 px-4 pb-12 pt-6 sm:px-6 lg:px-8">
              ...
              <section className="space-y-5" aria-labelledby="cards-examples-heading">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Static information card</h3><p className="mt-1 text-sm text-muted-foreground">A card can group related content without becoming an interaction.</p></div><div className="rounded-md border bg-muted/20 p-4"><section aria-labelledby="card-static-example"><h4 id="card-static-example" className="font-semibold">Application status</h4><p className="mt-1 text-sm text-muted-foreground">Your application is being reviewed.</p></section></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> a bounded group needs visual hierarchy.</p><p><strong>Avoid when:</strong> a card boundary adds decoration without helping comprehension.</p><p><strong>Check:</strong> the card has a useful heading and does not receive focus unless it contains a control.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Linked card</h3><p className="mt-1 text-sm text-muted-foreground">Make the actual link the interactive element.</p></div><div className="rounded-md border bg-muted/20 p-4"><article><h4 className="font-semibold"><a href="#card-linked-example" className="underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">View application details</a></h4><p className="mt-1 text-sm text-muted-foreground">Review status, documents, and next steps.</p></article></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> one destination describes the whole card.</p><p><strong>Avoid when:</strong> making every text fragment or the entire wrapper a competing link.</p><p><strong>Check:</strong> the link name describes the destination and has a visible focus ring.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Card with internal action</h3><p className="mt-1 text-sm text-muted-foreground">Use a button when the action changes state instead of navigating.</p></div><div className="rounded-md border bg-muted/20 p-4"><section aria-labelledby="card-action-example"><div className="flex flex-wrap items-start justify-between gap-3"><div><h4 id="card-action-example" className="font-semibold">Notifications</h4><p className="mt-1 text-sm text-muted-foreground">You have 3 unread notifications.</p></div><button type="button" className="rounded-md border px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">Mark all read</button></div></section></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> an action applies to the card’s content without changing location.</p><p><strong>Avoid when:</strong> nesting a button inside a link or making the card and button perform different unclear actions.</p><p><strong>Check:</strong> keyboard focus lands on the button and its result is communicated.</p></div></article>
                  <article className="space-y-3 rounded-lg border bg-card p-4"><div><h3 className="text-lg font-semibold">Responsive card grid</h3><p className="mt-1 text-sm text-muted-foreground">The grid changes density without changing the information hierarchy.</p></div><div className="grid gap-3 rounded-md border bg-muted/20 p-4 sm:grid-cols-2"><section aria-labelledby="card-grid-one"><h4 id="card-grid-one" className="font-semibold">Plan A</h4><p className="mt-1 text-sm text-muted-foreground">For small teams</p></section><section aria-labelledby="card-grid-two"><h4 id="card-grid-two" className="font-semibold">Plan B</h4><p className="mt-1 text-sm text-muted-foreground">For growing teams</p></section></div><div className="space-y-1 text-sm"><p><strong>Use when:</strong> repeated items share a clear comparison structure.</p><p><strong>Avoid when:</strong> cards become too narrow or require line-by-line comparison.</p><p><strong>Check:</strong> order, headings, and actions remain understandable at one column.</p></div></article>
                </div>
                  <p className="leading-7 text-muted-foreground">
