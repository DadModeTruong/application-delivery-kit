...
│   ├── pages/               React reference pages and route-level navigation data
...
- The route table and global navigation data live in `src/pages/index.tsx`; component-area navigation stays local to each guide so each page is self-contained.
