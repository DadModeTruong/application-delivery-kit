...
- `/layouts/header-only` — Header Only interactive demo
- `/layouts/secondary` — Secondary interactive demo
- `/layouts/sidebar` — Sidebar interactive demo
- `/layouts/full` — Full interactive demo
...
- [`src/pages/examples/README.md`](./src/pages/examples/README.md) — Layouts decision guides and demo boundary
- [`src/pages/layouts/README.md`](./src/pages/layouts/README.md) — focused interactive layout demos
...
│   │   ├── examples/        Layouts decision guides
│   │   ├── layouts/          Focused interactive layout demos
...
- `src/pages/` contains the reference application pages. Component guides live in `src/pages/components/`, Layouts decision guides live in `src/pages/examples/`, focused layout demos live in `src/pages/layouts/`, and shared demo-only compositions live in `src/pages/demos/`.
